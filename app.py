...
class Database:
    def __init__(self):
        ...
        # Passa credenciais explicitamente para o Drive
        authorized_http = self.creds_drive.authorize(httplib2.Http())
    ...
    def _autenticar_drive(self):
        ...
        if not creds:
            raise Exception("Credenciais do Drive não encontradas. Configure TOKEN_PICKLE.")
